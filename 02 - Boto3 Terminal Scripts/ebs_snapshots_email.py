...
ec2 = boto3.resource('ec2') # create EC2 resource
sns_client = boto3.client('sns') # create SNS client
...
# create list to hold snapshot Ids
snapshot_ids = []

# loop through filtered LIST of EC2 instances in ec2.Instance
for instance in ec2.instances.filter(Filters=backup_filter): # call filter() method on instances collection of EC2 class 
